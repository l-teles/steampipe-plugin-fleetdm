...
func tableFleetdmHostDetail(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			// Columns from the basic host list call
			...
			// Columns that require the getHostDetails hydration call
			{Name: "last_enrolled_at", Type: proto.ColumnType_TIMESTAMP, Hydrate: getHostDetails, Description: "Timestamp when the host last enrolled."},
			{Name: "last_mdm_checked_in_at", Type: proto.ColumnType_TIMESTAMP, Hydrate: getHostDetails, Description: "Timestamp when the host last checked in with MDM."},
			{Name: "last_mdm_enrolled_at", Type: proto.ColumnType_TIMESTAMP, Hydrate: getHostDetails, Description: "Timestamp when the host was last enrolled in MDM."},
			{Name: "detail_updated_at", Type: proto.ColumnType_TIMESTAMP, Hydrate: getHostDetails, Description: "Timestamp when the host details were last updated."},
			{Name: "label_updated_at", Type: proto.ColumnType_TIMESTAMP, Hydrate: getHostDetails, Description: "Timestamp when the host labels were last updated."},
			{Name: "policy_updated_at", Type: proto.ColumnType_TIMESTAMP, Hydrate: getHostDetails, Description: "Timestamp when the host policy status was last updated."},
			{Name: "software_updated_at", Type: proto.ColumnType_TIMESTAMP, Hydrate: getHostDetails, Description: "Timestamp when the host software inventory was last updated."},
			{Name: "last_restarted_at", Type: proto.ColumnType_TIMESTAMP, Hydrate: getHostDetails, Description: "Timestamp of the last host restart event."},
			...
			{Name: "platform_like", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "Platform-like classification (e.g., 'darwin')."},
			{Name: "build", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "The operating system build string."},
			{Name: "code_name", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "The OS code name."},
			{Name: "orbit_version", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "The version of Orbit running on the host."},
			{Name: "fleet_desktop_version", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "The version of Fleet Desktop running on the host."},
			{Name: "scripts_enabled", Type: proto.ColumnType_BOOL, Hydrate: getHostDetails, Description: "Indicates if running scripts is enabled for this host via Fleet."},
			{Name: "refetch_requested", Type: proto.ColumnType_BOOL, Hydrate: getHostDetails, Description: "Indicates if a refetch of host details has been requested."},
			{Name: "hardware_model", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "Hardware model."},
			{Name: "hardware_serial", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "Hardware serial number."},
			{Name: "hardware_vendor", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "Hardware vendor."},
			{Name: "hardware_version", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "Hardware version."},
			...
			{Name: "uptime", Type: proto.ColumnType_INT, Hydrate: getHostDetails, Description: "Uptime of the host in nanoseconds."},
			{Name: "memory", Type: proto.ColumnType_INT, Hydrate: getHostDetails, Description: "Total physical memory in bytes."},
			{Name: "cpu_type", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "CPU type."},
			{Name: "cpu_subtype", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "CPU subtype."},
			{Name: "cpu_brand", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "CPU brand string."},
			{Name: "cpu_physical_cores", Type: proto.ColumnType_INT, Hydrate: getHostDetails, Description: "Number of physical CPU cores."},
			{Name: "cpu_logical_cores", Type: proto.ColumnType_INT, Hydrate: getHostDetails, Description: "Number of logical CPU cores."},
			{Name: "gigs_disk_space_available", Type: proto.ColumnType_DOUBLE, Hydrate: getHostDetails, Description: "Gigabytes of disk space available."},
			{Name: "percent_disk_space_available", Type: proto.ColumnType_DOUBLE, Hydrate: getHostDetails, Description: "Percentage of disk space available."},
			{Name: "gigs_total_disk_space", Type: proto.ColumnType_DOUBLE, Hydrate: getHostDetails, Description: "Total gigabytes of disk space."},
			{Name: "public_ip", Type: proto.ColumnType_IPADDR, Hydrate: getHostDetails, Description: "The public IP address of the host."},
			{Name: "primary_ip", Type: proto.ColumnType_IPADDR, Hydrate: getHostDetails, Description: "The primary IP address of the host."},
			{Name: "primary_mac", Type: proto.ColumnType_STRING, Hydrate: getHostDetails, Description: "The primary MAC address of the host."},
			{Name: "distributed_interval", Type: proto.ColumnType_INT, Hydrate: getHostDetails, Description: "The distributed query interval for the host."},
			{Name: "config_tls_refresh", Type: proto.ColumnType_INT, Hydrate: getHostDetails, Description: "The config TLS refresh interval."},
			{Name: "logger_tls_period", Type: proto.ColumnType_INT, Hydrate: getHostDetails, Description: "The logger TLS period."},

			// Detailed JSON Columns (all require hydration)
